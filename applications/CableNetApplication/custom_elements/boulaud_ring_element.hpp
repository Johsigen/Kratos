...
namespace Kratos
{
    ...
    class KRATOS_API(CABLE_NET_APPLICATION) BoulaudRingElement : public Element
    {
    protected:

    public:
        KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(BoulaudRingElement);
        ...
        BoulaudRingElement() {};
        BoulaudRingElement(IndexType NewId,
