...
PYBIND11_MODULE(KratosCableNetApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NORMALFORCE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BENDING_STIFFNESS )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MINIMAL_LENGTH )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MINIMAL_CIRCUMFERENCE )
